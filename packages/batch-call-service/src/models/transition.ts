...
export interface TransitionCreationAttributes extends Optional<TransitionAttributes, 'id' | 'batchIndex' | 'txHash' | 'reason'> {}

export class Transition extends Model<TransitionAttributes, TransitionCreationAttributes>
